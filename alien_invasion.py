...
class AlienInvasion:
	"""Класс для упарвления ресурсами и поведением игры."""
	def __init__(self):
	...
	def run_game(self):
		...
		while True:
			...
			#Отображение последнего прорисовывания экрана.
			pygame.display.flip()

	def _check_events(self):
		"""Отображает нажатия клавиш и события мыши."""
	...
	def _update_bullets(self):
		...
		#Проверка попаданий в прищельцев
		#При обнаружении попажания удалить снаряд и прищельца
	...
	def _update_aliens(self):
		...
		#Поверка коллюзий "пришелец-корабль".
		if pygame.sprite.spritecollideany(self.ship, self.aliens):
			self._ship_hit()

		#Проверить, добрались ли прищельцы до нижнего края экрана.
	...
	def _check_bullet_alien_collisions(self):
		...
		#Удаление снарядов и прищельцев, участвующих в коллюзиях.
